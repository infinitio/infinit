...
BOOST_AUTO_TEST_CASE(mix)
{
  ...
  auto client = [=] (reactor::Thread* serv)
  {
    ...
    // Mega mix!
    {
      ...
      //    5        1          6          2  |________________|
      //                                               4

      // First simple message.
      std::string msg1("is a message ");
      elle::Buffer input1(msg1.c_str(), msg1.size());
      ...
      BOOST_CHECK(test_content(msg2, tid, 0, 23));
      ...
      BOOST_CHECK(test_content(msg2 + msg4, tid, 0, 23));
      ...
      BOOST_CHECK(test_content(msg5, tid, 0, 0));

      std::string msg6("that ");
      elle::Buffer input6(msg6.c_str(), msg6.size());
      BOOST_CHECK_EQUAL(handler.store(0, 18, input6), input6.size());
      BOOST_CHECK(test_content(msg5 + msg1 + msg6 + msg2 + msg4, tid, 0, 0));
    }
