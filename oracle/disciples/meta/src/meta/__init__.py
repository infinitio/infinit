...
class Meta:
    def __init__(self,
        ...
        self.apertus_control_port = apertus_control_port
...
# in exclusive creation mode ('x') already exists.
    ...
    def __enter__(self):
        ...
        if self.apertus_control_port is not None:
            command.append('--apertus-control-port')
            command.append(str(self.apertus_control_port))
        if self.no_apertus:
