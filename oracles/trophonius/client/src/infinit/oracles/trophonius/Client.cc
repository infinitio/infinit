...
ELLE_SERIALIZE_NO_FORMAT(infinit::oracles::trophonius::PeerConnectionUpdateNotification);
ELLE_SERIALIZE_SIMPLE(infinit::oracles::trophonius::PeerConnectionUpdateNotification,
                      ar,
                      value,
                      version)
{
