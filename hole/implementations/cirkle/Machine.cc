...
//
      ...
      elle::Status      Machine::Launch()
      {
        ...
        //
        {
          ...
          if (elle::network::Network::Register(
            ...
            throw Exception("unable to register the callback");
        ...
        //
        {
          ...
          if (Hole::Descriptor.Get("cirkle", "neighbours",
            ...
            throw Exception("unable to retrieve the cirkle's host address from the "
                   "network descriptor");

          // build the host locus.
          if (locus.Create(string) == elle::Status::Error)
            throw Exception("unable to create the host locus");
          ...
          if (Hole::Descriptor.Get("cirkle", "port",
              ...
              elle::Status::Error)
            throw Exception("unable to retrieve the cirkle's local port from the "
                   "network descriptor");
        }
        ...
        //
        {
          ...
          if (locus.Create(host, this->port) == elle::Status::Error)
            throw Exception("unable to create the locus");
          ...
          if (elle::Bridge::Listen(locus,
              ...
              elle::Status::Error)
            throw Exception("unable to listen for bridge connections");
        }
                                     ...
                                     const nucleus::ImmutableBlock& block)
      {
        ...
        if (this->state != Machine::StateAuthenticated)
          throw Exception("the machine does not seem to have been authenticated");
        ...
        if (this->gate->Call(
          ...
          throw Exception("unable to transfer the request");
        */
        return elle::Status::Ok;
      }
...
//
      ...
      elle::Status      Machine::Connection(elle::Gate*                 gate)
      {
        ...
        if (this->neighbourhood.Add(neighbour->locus,
                                    neighbour) == elle::Status::Error)
          throw Exception("unable to add the neighbour to the neigbourhood");

        // challenge the neighbour.
        if (neighbour->gate->Send(
              elle::network::Inputs<TagChallenge>()) == elle::Status::Error)
          throw Exception("unable to send the challenge");
        ...
        if ((neighbour->label != Label::Null) &&
            (neighbour->port != 0))
          {
            ...
            if (this->routingtable.Exist(neighbour->label) == true)
              {
                ...
                if (this->neighbourhood.Remove(
                  ...
                  throw Exception("unable to remove the neighbour");
            ...
            if (this->routingtable.Add(neighbour->label,
                                       neighbour) == elle::Status::Error)
              throw Exception("unable to add the neighbour to the routing table");

            // acknowledge the authentication.
            if (neighbour->gate->Reply(
                  elle::network::Inputs<TagAuthenticated>()) == elle::Status::Error)
              throw Exception("unable to acknowledge the authentication");
      ...
      elle::Status      Machine::Update(const Cluster&          cluster)
      {
        ...
        if (this->state != Machine::StateAuthenticated)
          throw Exception("the machine has not been authenticated yet");

        // check that the neighbour has been authenticated.
        if (neighbour->state != Neighbour::StateAuthenticated)
          throw Exception("unable to process gossip from unauthenticated neighbours");
      ...
      elle::Status      Machine::Gossip()
      {
        ...
        if (cluster.Create(this->routingtable) == elle::Status::Error)
          throw Exception("unable to create the cluster");
        ...
        for (scoutor = this->routingtable.container.begin();
             ...
             scoutor++)
          {
            ...
            if (neighbour->gate->Send(
              ...
              throw Exception("unable to send the cluster");
          }
...
//
      ...
      elle::Status      Machine::Dump(const elle::Natural32     margin) const
      {
        ...
        if (this->neighbourhood.Dump(margin + 2) == elle::Status::Error)
          throw Exception("unable to dump the neighbourhood");

        // dump the routing table.
        if (this->routingtable.Dump(margin + 2) == elle::Status::Error)
          throw Exception("unable to dump the routing table");

        // dump the timer.
        if (this->timer.Dump(margin + 2) == elle::Status::Error)
          throw Exception("unable to dump the timer");
